-- ============================================
-- SCRIPT DE CORRECCIÓN: CAMBIAR asset_id DE UUID A BIGINT
-- ============================================
-- Si ya ejecutaste el script anterior y las tablas tienen asset_id como UUID,
-- ejecuta este script para corregir el tipo de dato.
-- 
-- IMPORTANTE: Este script eliminará todas las alertas y notificaciones existentes
-- porque no se pueden convertir UUID a BIGINT directamente.
-- Si tienes datos importantes, haz un backup primero.

-- Eliminar las tablas existentes (esto eliminará todos los datos)
DROP TABLE IF EXISTS notifications CASCADE;
DROP TABLE IF EXISTS alerts CASCADE;

-- Recrear las tablas con el tipo correcto
-- Tabla de alertas
CREATE TABLE alerts (
